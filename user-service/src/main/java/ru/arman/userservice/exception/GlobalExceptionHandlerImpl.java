...
public class GlobalExceptionHandlerImpl {
    ...
    public ResponseEntity<ErrorResponse> handleRoleAssignException(RuntimeException e, HttpServletRequest request) {
        return ResponseEntity.badRequest().body(errorResponseBuilder(e, request));
    }

    @ExceptionHandler(KeycloakUserCreationException.class)
    public ResponseEntity<ErrorResponse> handleKeycloakUserCreationException(KeycloakUserCreationException e, HttpServletRequest request) {
